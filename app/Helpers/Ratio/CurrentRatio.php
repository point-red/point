...
class CurrentRatio extends Ratio implements RatioContract
{
    ...
    public function get($dateFrom, $dateTo) {
        ...
        for ($i = 0; $i < $months; $i++) {
            ...
            $value = $this->getRatio($this->getTotal($this->currentAssets, $date), $this->getTotal($this->currentLiability, $date));
