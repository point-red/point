...
class ReturnOfEquity extends Ratio implements RatioContract
{
    ...
    public function get($dateFrom, $dateTo)
    {
        ...
        for ($i = 0; $i < $months; $i++) {
            ...
            $value = $this->getRatio($this->getTotalNetProfit($date), $this->getTotal(array_merge($this->equity, array_merge($this->currentLiability)), $date));
