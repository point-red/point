...
class CurrentRatioController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return response()->json([
            'data' => [
                'description' => 'berapa kekuatan perusahaan untuk membayar hutang jangka pendek menggunakan asset lancar?',
                'result' => 'rasio untuk mengukur kemampuan perusahaan dalam membayar kewajiban finansial jangka pendek dengan mengunakan asset lancar, nilai ideal adalah 150%',
                'labels' => $labels,
                'values' => $values
            ]
        ]);
