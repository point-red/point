...
class EmployeeSalaryController extends Controller
{
    ...
    public function store(StoreEmployeeSalaryRequest $request, $employeeId)
    {
        if ($request->get('date') && count($request->get('date')) == 2) {
            ...
            $employee_salary->weekly_payment_week1 = $achievements['weekly_payment']['week1'] ?? 0;
            $employee_salary->weekly_payment_week2 = $achievements['weekly_payment']['week2'] ?? 0;
            $employee_salary->weekly_payment_week3 = $achievements['weekly_payment']['week3'] ?? 0;
            $employee_salary->weekly_payment_week4 = $achievements['weekly_payment']['week4'] ?? 0;
            $employee_salary->weekly_payment_week5 = $achievements['weekly_payment']['week5'] ?? 0;
            ...
            if ($project->code === $project_code) {
                foreach ($queryValueCashCredit as $value) {
                    if (isset($value['week_of_month'])) {
                        ...
                        $employee_achievements['weekly_payment'][$value['week_of_month']] += (float) $value['value'];
                    }
                }
            }
        }
