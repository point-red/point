...
class EmployeeSalaryResource extends JsonResource
{
    ...
    public function toArray($request)
    {
        return [
            ...
            'weekly_payment_week1' => $this->weekly_payment_week1,
            'weekly_payment_week2' => $this->weekly_payment_week2,
            'weekly_payment_week3' => $this->weekly_payment_week3,
            'weekly_payment_week4' => $this->weekly_payment_week4,
            'weekly_payment_week5' => $this->weekly_payment_week5,
