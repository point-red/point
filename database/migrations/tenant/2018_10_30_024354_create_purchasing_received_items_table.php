...
class CreatePurchasingReceivedItemsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('purchasing_received_items', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('purchasing_received_items');
    }
}
