...
class CreateEmployeeSalariesTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('employee_salaries', function (Blueprint $table) {
            ...
            $table->double('receiveable_cut_60_days_week1')->default(0);
            $table->double('receiveable_cut_60_days_week2')->default(0);
            $table->double('receiveable_cut_60_days_week3')->default(0);
            $table->double('receiveable_cut_60_days_week4')->default(0);
            $table->double('receiveable_cut_60_days_week5')->default(0);
