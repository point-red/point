...
class ChartOfAccountSeeder extends Seeder
{
    ...
    private function chartOfAccount()
    {
        ...
        $longTermLiability = ['gaji ymh dibayar', 'sewa ymh dibayar', 'listrik, air & telpon ymh dibayar', 'asuransi ymh dibayar', 'lain-lain ymh dibayar', 'sewa ymh dibayar', 'utang bank jangka panjang'];
        $longTermLiabilityNumber = ['20501', '20502', '20503', '20504', '20505', '20599', '21001'];
        ...
        for ($i = 0; $i < count($equity); $i++) {
            ...
            $chartOfAccount->number = $equityNumber;
