...
<table width="100%" style="border: 1px solid #000;" cellspacing="4">
    <thead>
    	<tr>
	        <th colspan="7" style="text-align:center;"><b>INVOICE</b></th>
	    </tr>
    	<tr>
	        <th width="5%">
	        	<br/>
	...
	<tbody>
    	<tr style="height:14px;">
	    	<td></td>
	        <td>NAME:</td>
	        <td colspan="5">{{ $employeeSalary->employee->name }}</td>
	    </tr>
	   	<tr>
	   		<td></td>
	        <td>JOB LOCATION:</td>
	        <td colspan="5">{{ $employeeSalary->job_location }}</td>
	    </tr>
	   	<tr>
	   		<td></td>
	        <td>PERIOD:</td>
	    ...
	    <tr>
	        ...
	        <td style="text-align:center;">{{ number_format($employeeSalary->receiveable_cut_60_days_week1, 2) }}</td>
	        <td style="text-align:center;">{{ number_format($employeeSalary->receiveable_cut_60_days_week2, 2) }}</td>
	        <td style="text-align:center;">{{ number_format($employeeSalary->receiveable_cut_60_days_week3, 2) }}</td>
	        <td style="text-align:center;">{{ number_format($employeeSalary->receiveable_cut_60_days_week4, 2) }}</td>
	        <td style="text-align:center;">{{ number_format($employeeSalary->receiveable_cut_60_days_week5, 2) }}</td>
	    </tr>
	    <tr>
