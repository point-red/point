...
<table width="100%" style="border: 1px solid #000;" cellspacing="4">
	...
	<tbody>
	    ...
	    <tr>
	        ...
	        <td style="text-align:center;">{{ number_format($calculatedSalaryData['total_payment'], 2) }}</td>
	    </tr>
	    <tr>
	    ...
	    <tr>
	        <td colspan="2">Weekly Payment</td>
	        <td style="text-align:center;">{{ number_format($employeeSalary->weekly_payment_week1, 2) }}</td>
	        <td style="text-align:center;">{{ number_format($employeeSalary->weekly_payment_week2, 2) }}</td>
	        <td style="text-align:center;">{{ number_format($employeeSalary->weekly_payment_week3, 2) }}</td>
	        <td style="text-align:center;">{{ number_format($employeeSalary->weekly_payment_week4, 2) }}</td>
	        <td style="text-align:center;">{{ number_format($employeeSalary->weekly_payment_week5, 2) }}</td>
	        <td>&nbsp;</td>
	    </tr>
	    <tr>
