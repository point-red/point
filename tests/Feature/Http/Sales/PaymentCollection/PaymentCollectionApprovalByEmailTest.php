...
class PaymentCollectionApprovalByEmailTest extends TestCase
{
    ...
    public function testApproveReferenceDone()
    {
      $this->dummyChartofAccount();
      ...
      $salesPaymentCollection = PaymentCollection::orderBy('id', 'asc')->first();
      
      $data = [
        "id" => $salesPaymentCollection->id
      ];

      $approver = TenantUser::findOrFail($salesPaymentCollection->form->request_approval_to);
    ...
    public function testRejectCancellationApproval()
    {
        // success
        $this->dummyChartofAccount();
