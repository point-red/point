...
class PaymentCollectionCancellationApprovalTest extends TestCase
{
    ...
    public function testApprove()
    {
        ...
        $response = $this->json('POST', self::$path.'/'.$salesPaymentCollection->id.'/cancellation-approve', $data, $this->headers);
    ...
    public function testRejectApproval()
    {
        ...
        $response = $this->json('POST', self::$path.'/'.$salesPaymentCollection->id.'/cancellation-reject', $data, $this->headers);
