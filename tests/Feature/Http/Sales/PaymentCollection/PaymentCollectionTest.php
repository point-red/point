...
class PaymentCollectionTest extends TestCase
{
    ...
    public function testCreate()
    {
        ...
        $response = $this->json('POST', '/api/v1/sales/payment-collection', $data, $this->headers);
    ...
    {
        // all data
        $response = $this->json('GET', '/api/v1/sales/payment-collection', [
        ...
        $response = $this->json('GET', self::$path.'/'.$salesPaymentCollection->id, [
    ...
    public function testUpdatePaymentCollection()
    {
        // success
        $this->testCreate();
        ...
        $data["id"] = $salesPaymentCollection->id;

        $response = $this->json('PATCH', self::$path.'/'.$salesPaymentCollection->id, $data, [$this->headers]);
        ...
        $payment = new Payment;
        $payment->payment_type = $salesPaymentCollection->payment_type;
        $payment->payment_account_id = $coa->id;
        $payment->disbursed = 0;
        $payment->paymentable_id = $salesPaymentCollection->id;
        $payment->paymentable_id = $salesPaymentCollection->customer_id;
        $payment->paymentable_type = 'Customer';
        $payment->paymentable_name = $salesPaymentCollection->customer_name;
        $payment->save();
        ...
        $paymentDetail->amount = $salesPaymentCollection->amount;
        $paymentDetail->referenceable_id = $salesPaymentCollection->id;
        $paymentDetail->referenceable_type = 'PaymentCollection';
        $paymentDetail->save();

        $defaultNumberPostfix = '{y}{m}{increment=4}';
        $form = new Form;
        $form->branch_id =  $salesPaymentCollection->form->branch_id;
        $form->date = date("Y-m-d H:i:s");
        $form->increment_group = date("Ym");
        $form->notes = "some notes";
        $form->created_by = $salesPaymentCollection->form->created_by;
        $form->updated_by = $salesPaymentCollection->form->updated_by;
        $form->formable_id = $payment->id;
        $form->formable_type = 'Payment';
	    $form->number = 'CASH/IN/22080001';
        $form->request_approval_to = $salesPaymentCollection->form->request_approval_to;
        $form->approval_by = $salesPaymentCollection->form->request_approval_to;
        $form->done = 1;
        $form->save();

        $salesPaymentCollection = PaymentCollection::findOrFail($salesPaymentCollection->id);
        ...
        $form = $salesPaymentCollection->form;
        $form->branch_id = $form->branch_id + 1;
        $form->save();
    ...
    public function testDeletePaymentCollection()
    {
        // success
        $this->testCreate();
        ...
        $response = $this->json('DELETE', self::$path.'/'.$salesPaymentCollection->id, [], [$this->headers]);
    ...
    /** @test */
    public function testExportPaymentCollection()
    {
        $this->testCreate();
    ...
    public function testGenerateFormNumber()
    {
        $this->dummyChartofAccount();
